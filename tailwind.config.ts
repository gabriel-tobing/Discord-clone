  ...
  theme: {
    extend: {
      backgroundColor: {
        ...
        positive: "hsl(142 calc(1 * 56.1%) 32.2% / 1)",
        ...
        "channel-textarea": "hsl(225 calc(1 * 6.7%) 23.5% / 1)",
      },
      backgroundImage: {
      ...
      colors: {
        ...
        "status-danger": "hsl(359 calc(1 * 87.3%) 59.8% / 1)",
        "brand-experiment-200": "hsl(236 calc(1 * 83.3%) 92.9% / 1)",
        "channel-placeholder": "hsl(229 calc(1 * 4.8%) 44.9% / 1)",
      },
      boxShadow: {
      ...
      spacing: {
        message: "calc(40px + 16px + 16px)",
        role: "calc(4px + 1rem)",
        "message-profile": "calc(4px - 0.125rem)",
        "message-container": "calc(-1 * calc(40px + 16px + 16px))",
      },
    },
  },
  plugins: [],
};
// hsl(229 calc(1 * 4.8%) 44.9% / 1)
